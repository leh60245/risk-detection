...
def get_args_parser():
    ...
    parser.add_argument('--augment-train-data', action="store_true")
    parser.add_argument('--no-augment-train-data', action='store_false', dest='augment_train_data')
    parser.set_defaults(augment_train_data=True)
...
def main(args):
    ...
    model = create_model(
        ...
        # img_size=tuple(args.input_size)[0]
    )
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Risk Detection Model training and evaluation script', parents=[get_args_parser()])
